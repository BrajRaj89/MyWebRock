...
{
String requesturl="//my//"+className+"//"+m.getName();
...
String requesturl="//my//"+className+"//"+mname+"?"+pname+"=";
...
{
raf.close();
System.out.println("file created "+DestinationFile.getAbsolutePath());
}
}
raf.close();
System.out.println("file created "+DestinationFile.getAbsolutePath());
...
{
System.out.println("do get of TMWebRockStarter");
}
}